...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresenter.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (selectedUser.compareTo(Cache.getInstance().getCurrUser()) == 0) {
            ...
            presenter.initiateIsFollowerTask(Cache.getInstance().getCurrUserAuthToken(), Cache.getInstance().getCurrUser(), selectedUser);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.logoutMenu) {
            ...
            logOutToast.show();
            presenter.initiateLogout(Cache.getInstance().getCurrUserAuthToken());
